...
def listen_fm():
    """
    Receives waves from the specified frequency, demodulates them
    as FM and saves it in the current folder.
    """
    ...
    # Low-Pass Filter
    taps = scipy.signal.firwin(numtaps=101, cutoff=7.5e3, fs=sdr.sample_rate)
    ...
    # Resample to 19kHz
    x = scipy.signal.resample_poly(x, 19, 25) # up, down
    sample_rate = 19e3
